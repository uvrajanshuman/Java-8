...
### reduce <br> `Optional.OptionalExample<T> reduce(BinaryOperator<T> accumulator)`
...
- This is equivalent to:
  ```java
    ...
    return foundAny ? Optional.OptionalExample.of(result) : Optional.OptionalExample.empty();
  ```
...
### max <br> `Optional.OptionalExample<T> max(Comparator<? super T> comparator)`

- This is a terminal operation.
- Returns the maximum element of this stream according to the provided Comparator. 
- This is a special case of a reduction.

### min <br> `Optional.OptionalExample<T> min(Comparator<? super T> comparator)`
...
public class App {
  public static void main(String[] args) {
    ...
    Optional.OptionalExample<Integer> minElement = integerList.stream()
            .min(Comparator.naturalOrder());
    Optional.OptionalExample<Integer> maxElement = integerList.stream()
...
public class App {
  public static void main(String[] args) {
    List<Integer> integerList = Arrays.asList(1, 2, 3, 4, 5, 6);
    Optional.OptionalExample<Integer> firstThreeSum = integerList
...
public class App {
  public static void main(String[] args) {
    List<Integer> integerList = Arrays.asList(1, 2, 3, 4, 5, 6);
    Optional.OptionalExample<Integer> skipThreeSum = integerList
            .stream() // Stream<Integer> // all integers of integerList.
...
### findFirst <br> Optional.OptionalExample<T> findFirst()

- This is a short-circuiting terminal operation.
- Returns an Optional.OptionalExample describing the first element of this stream, or an empty Optional.OptionalExample if the stream is empty. 
- Returns the first element in the stream.

### findAny <br> Optional.OptionalExample<T> findAny()
- This is a short-circuiting terminal operation.
- Returns an Optional.OptionalExample describing some element of the stream, or an empty Optional.OptionalExample if the stream is empty.
